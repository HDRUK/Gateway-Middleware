...
describe("index.js", () => {
    ...
    it("Should check that the hdrDataModelSearch Query is defined correctly", () => {
        expect(typeDefs.definitions[0].fields[1].name.value).toEqual("hdrDataModelSearch");
        expect(typeDefs.definitions[0].fields[1].type.kind).toEqual("NamedType");
        expect(typeDefs.definitions[0].fields[1].type.name.value).toEqual("HDR_MetaData");
    });
    ...
    it("Should check the hdrCatalogueItemsSearch input parameters", () => {
        expect(typeDefs.definitions[0].fields[4].arguments.length).toEqual(3);
        expect(typeDefs.definitions[0].fields[4].arguments[0].name.value).toEqual("searchTerm");
        expect(typeDefs.definitions[0].fields[4].arguments[0].type.name.value).toEqual("String");

        expect(typeDefs.definitions[0].fields[4].arguments[1].name.value).toEqual("recordOffset");
        expect(typeDefs.definitions[0].fields[4].arguments[1].type.kind).toEqual("NonNullType");
        expect(typeDefs.definitions[0].fields[4].arguments[1].type.type.name.value).toEqual("Int");

        expect(typeDefs.definitions[0].fields[4].arguments[2].name.value).toEqual("recordLimit");
        expect(typeDefs.definitions[0].fields[4].arguments[2].type.kind).toEqual("NonNullType");
        expect(typeDefs.definitions[0].fields[4].arguments[2].type.type.name.value).toEqual("Int");
    });
    it("Should test the getSearchAuditLog Field Definition", () => {
        ...
        expect(typeDefs.definitions[1].fields).toHaveLength(6);
        ...
        expect(typeDefs.definitions[1].fields[1].name.value).toEqual("search_user_ID");
        ...
        expect(typeDefs.definitions[1].fields[2].name.value).toEqual("search_Detail");
        ...
        expect(typeDefs.definitions[1].fields[3].name.value).toEqual("search_end_point");
        ...
        expect(typeDefs.definitions[1].fields[4].name.value).toEqual("created_on");
        expect(typeDefs.definitions[1].fields[4].type.kind).toEqual("NamedType");
        expect(typeDefs.definitions[1].fields[4].type.name.value).toEqual("String");

        expect(typeDefs.definitions[1].fields[5].name.value).toEqual("last_updated");
        expect(typeDefs.definitions[1].fields[5].type.kind).toEqual("NamedType");
        expect(typeDefs.definitions[1].fields[5].type.name.value).toEqual("String");
    });
    it("Should test the hdrNoSearch Field Definition", () => {
        expect(typeDefs.definitions[2].kind).toEqual("ObjectTypeDefinition");
        expect(typeDefs.definitions[2].name.value).toEqual("HDR_MetaData");
        ...
        expect(typeDefs.definitions[2].fields[3].type.kind).toEqual("ListType");
        expect(typeDefs.definitions[2].fields[3].type.type.name.value).toEqual("HDR_MetaData_Result");
    });
